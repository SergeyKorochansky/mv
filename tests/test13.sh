...
function test_13() {
    create_env
    print_yeallow 'Running Test #13: Numbered backup with default suffix'
    FILE1='file1'
    FILE2='file2'
    FILE3='file3'
    BAKUP_SUFFIX='~'
